 ...
 *
 */
public class Ips31 extends Activity {
				...
				try {
					while (parser.next() != XmlPullParser.END_DOCUMENT) {
						...
						if((name != null) && (name.equals("text"))) {
				    		...
				    		{if(parser.getText().equals("Option3-1 Parole et dialogue")){
						...
						if((name != null) && (name.equals("courseCode"))) {
							...
							if(parser.next() == XmlPullParser.TEXT)
				    		{if(parser.getText().equals("OptionIPS-3-1")){
				    			stringBuilder.append("\nCode   : "+parser.getText());}
				    		}
						...
						if((name != null) && (name.equals("infoBlock"))) {
							...
							if(parser.next() == XmlPullParser.TEXT)
				    		{if(parser.getText().contains("1. Acoustique : traitement du signal pour la reconnaissance de la parole.")){
