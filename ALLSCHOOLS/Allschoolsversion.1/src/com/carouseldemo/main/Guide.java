...
public class Guide extends Activity {
    ...
    void examineJSONFile()
    {
    	try
    	{
    		String x = "";
    		String x1 = "";
    		InputStream is = this.getResources().openRawResource(R.raw.guide);
           ...
           for (i=0;i<menuitemArray1.length();i++)
    			
    		{
   			...
   			.toString() + "\n";
    			...
    			x1 += menuitemArray1.getJSONObject(i).getString("TextLeft")
                .toString() ;
    			x1 += "    "+menuitemArray1.getJSONObject(i).getString("TextRight")
    			.toString() + "\n\n";
    		}
