 ...
 *
 */
public class Astre25 extends Activity {
				...
				try {
					while (parser.next() != XmlPullParser.END_DOCUMENT) {
						...
						if((name != null) && (name.equals("text"))) {
				    		...
				    		{if(parser.getText().equals("ASTRE2-5 Traitement du signal : echantillonnage et asservissement numerique")){
						...
						if((name != null) && (name.equals("courseCode"))) {
							...
							if(parser.next() == XmlPullParser.TEXT)
				    		{if(parser.getText().equals("ASTRE2-5")){
				    			stringBuilder.append("\nCode   : "+parser.getText());}
				    		}
						...
						if((name != null) && (name.equals("subBlock"))) {
							...
							if(parser.next() == XmlPullParser.TEXT)
				    		{if(parser.getText().equals("25.15")){
						...
						if((name != null) && (name.equals("infoBlock"))) {
							...
							if(parser.next() == XmlPullParser.TEXT)
				    		{if(parser.getText().contains("2. Electronique des systemes boucles.")){
