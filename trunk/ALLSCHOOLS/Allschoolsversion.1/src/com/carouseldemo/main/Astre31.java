 ...
 *
 */
public class Astre31 extends Activity {
				...
				try {
					while (parser.next() != XmlPullParser.END_DOCUMENT) {
						...
						if((name != null) && (name.equals("text"))) {
				    		...
				    		{if(parser.getText().equals("ASTRE3-1 Systemes Temps Reel : architecture et programmation")){
						...
						if((name != null) && (name.equals("courseCode"))) {
							...
							if(parser.next() == XmlPullParser.TEXT)
				    		{if(parser.getText().equals("ASTRE3-1")){
				    			stringBuilder.append("\nCode   : "+parser.getText());}
				    		}
						...
						if((name != null) && (name.equals("infoBlock"))) {
							...
							if(parser.next() == XmlPullParser.TEXT)
				    		{if(parser.getText().contains("Partage des ressources et exclusion mutuelle.")){
